...
Voir solde :
    ...
    - ajouter boutons : faire un depot, faire un retrait, transferer argent.


Faire un depot,retrait,transfert:
    - formulaire.php generique :
        
        input prerempli de montant, input prerempli de code, input prerempli de numero aussi. 
        if ($transfert == true) {
            input prerempli du numero destinataire.
        }
        input hidden id_type_operation.
        bouton valider.
    ...
    - HistoriqueModel :
        ...
        logique generale
        $frais = getFrais($id_type_operation,$montantsaisie);
        $montant = $montantsaisie - $frais ;
        
        insert->($montant,$frais,$destinataire ?? null...);
